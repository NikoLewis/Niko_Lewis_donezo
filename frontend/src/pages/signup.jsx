...
//  I can't figure out where the below line came from :(
...
function SignUpForm  (){
  //STEP 29:  6. Then, create an `onSubmit` event in our `SignupForm` component's `form` element with the `handleSubmit` method and a value of `signupUser`
  //   1. Again, if you’re unsure how to do so, refer to step 7.
  return (
